...
def demo_entries() -> list[TerminologyEntry]:
    return [
        ...
        TerminologyEntry(
            ...
            code_system="ICD-10-TT06",
            code="B00",
            preferred_term="Bệnh do nhiễm virus herpes [herpes simplex]",
            synonyms=(
        ...
        TerminologyEntry(
            ...
            code_system="ICD-10-TT06",
            code="B01",
            preferred_term="Bệnh thuỷ đậu",
            synonyms=("bệnh thủy đậu",),
            release_id="TT06-2026",
            source_url=VIETNAM_ICD10_TT06_URL,
        ),
        TerminologyEntry(
            ...
            code_system="ICD-10-TT06",
            code="B02",
            preferred_term="Bệnh zona [herpes zoster] [bệnh giời leo]",
            synonyms=(
                "bệnh zona",
                "zona",
            ),
        ...
        TerminologyEntry(
            ...
            code_system="ICD-10-TT06",
            code="C83.3",
            preferred_term="U lympho tế bào B lớn lan toả",
            synonyms=(
